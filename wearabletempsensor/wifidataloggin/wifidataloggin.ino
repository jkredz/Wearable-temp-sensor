...
String WIFI_SSID = "Wibbly Wobbly Timey Wimey Stuff";
...
String WIFI_PSK = "v2qvspr6Zsa8FxV";
...
const String vmeasuredField = "vmeasured";
const String timeField = "time";
// const String skintempcField = "skintempc";
// const String skintempfField = "skintempf";
// const String skintempkField = "skintempk";
...
/////////////////////////////
const int vmeasured = A0; // thermistor voltage reading
...
int sendData()
{
  ...
  readSensors(); // Get updated values from sensors.
  phant.add(vmeasuredField, vmeasured);
...
void readSensors()
{
   vmeasured = analogRead(vmeasured);
}
